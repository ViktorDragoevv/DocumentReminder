...
function Locations() {
    ...
    const addLocationFromChild = newLocation => {
        setDataLocations(AddKeyProp([...dataLocations, newLocation]));
        console.log(newLocation);
    }

    const updateLocationFromChild = newLocation => {
    ...
    return (
        ...
        <div>
            ...
            <CustomModalLocations status={1} update={addLocationFromChild}></CustomModalLocations>
            <CustomModalLocations status={2} update={updateLocationFromChild} selectedRowKeys={selectedLocationObject}></CustomModalLocations>
