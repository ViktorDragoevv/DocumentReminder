...
namespace Document.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        public LoginModel(SignInManager<ApplicationUser> signInManager, ILogger<LoginModel> logger, IOptions<AppSettings> appSettings, IAuthService authService, UserManager<ApplicationUser> userManager)
        {
